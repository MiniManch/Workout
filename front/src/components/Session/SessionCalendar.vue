      ...
      <div class="calendar">
        ...
        <div class="days">
          <div class="day" v-for="day in days" :key="day.date">
            ...
            <div v-for="appointment in day.appointments" :key="appointment.SessionID" class="appointment">
              {{ appointment.ClientName }} at {{ formatTime(appointment.StartTime) }}
            </div>
          </div>
        </div>
      </div>
    ...
    computed: {
      ...
      days() {
        ...
        for (let day = start; day <= end; day.setDate(day.getDate() + 1)) {
          ...
          days.push({
            date,
            appointments: this.appointments.filter(appointment => appointment.Date === date.toISOString().split('T')[0])
          });
        }
        return days;
      }
